        ...
        <div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="release_date" class="form-control" value="<?php echo $album['release_date']; ?>" required>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <label for="editAlbum">Genre:</label>
                    <textarea class="form-control" name="genre"><?php echo $album['genre'] ?></textarea>
